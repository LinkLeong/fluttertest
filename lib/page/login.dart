...
import 'package:tab_bar/router/application.dart';
...
/*     return Stack(
  ...
  Widget build(BuildContext context) {
    var menuWidgets = <Widget>[
      menuButton(context, 'static/images/ic_transform_native_hz.png',
          "Native Animation", "native"),
      menuButton(context, 'static/images/ic_transform_fade_in_hz.png',
          "Preset (Fade In)", "preset-fade"),
      menuButton(context, 'static/images/ic_transform_global_hz.png',
          "Preset (Global transition)", "fixed-trans"),
      menuButton(context, 'static/images/ic_transform_custom_hz.png',
          "Custom Transition", "custom"),
      menuButton(context, 'static/images/ic_result_hz.png', "Navigator Result",
          "pop-result"),
      menuButton(context, 'static/images/ic_function_hz.png', "Function Call",
          "function-call"),
    ];
        ...
        child: Column(
          ...
          children: <Widget>[
            Padding(
              ...
              child: Image(
                image: AssetImage("static/images/logo_fluro.png"),
                width: 100.0,
              ),
            ),
            Expanded(
